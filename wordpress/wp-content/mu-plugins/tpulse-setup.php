...
function tpulse_sync_managed_pages(): void {
    ...
    $reviews_fr = '<div class="legal-document"><p class="legal-intro">Vos retours aident les autres archers à choisir et T-Pulse Archery à faire évoluer ses produits.</p><div class="legal-card"><h2>Déposer un avis</h2><p>Choisissez le produit concerné et partagez votre expérience avec le plus de précision possible.</p><div class="wp-block-buttons"><div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/produit/helitwist-original/#reviews">Noter HeliTwist</a></div><div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/produit/jeux-darchers/#reviews">Noter le livre</a></div></div></div><div class="legal-card tpulse-product-review-card"><span class="eyebrow">Avis HeliTwist</span><h2>Les retours des archers</h2>[tpulse_product_reviews product="helitwist-original"]<p>Votre retour sur le ressenti après la décoche, le filetage utilisé et votre configuration peut vraiment aider les prochains archers à choisir le bon modèle.</p><a class="button secondary" href="/produit/helitwist-original/#reviews">Laisser un avis HeliTwist</a></div><div class="legal-card tpulse-amazon-review-card"><span class="eyebrow">Avis du livre</span><h2>Le livre est aussi noté sur Amazon</h2><div class="tpulse-amazon-rating"><span class="external-rating-score">4,5/5</span><span class="tpulse-amazon-stars" aria-label="4,5 étoiles sur 5">★★★★★</span><span>21 évaluations Amazon</span></div><h3>Avis déposés sur la boutique</h3>[tpulse_product_reviews product="jeux-darchers"]<p>Une partie des premiers lecteurs a acheté <em>Jeux d’archers</em> sur Amazon. Pour consulter ces retours, la fiche Amazon reste accessible en complément des avis déposés ici.</p><a class="button secondary" href="https://www.amazon.fr/Jeux-darchers-Perfectionnez-darcherie-samuser/dp/B0DLWNRBPQ#customerReviews" target="_blank" rel="noopener external nofollow">Voir les avis Amazon</a></div></div>';
    $reviews_en = '<div class="legal-document"><p class="legal-intro">Your feedback helps other archers make an informed choice and helps T-Pulse Archery improve its products.</p><div class="legal-card"><h2>Leave a review</h2><p>Select the relevant product and describe your experience as precisely as possible.</p><div class="wp-block-buttons"><div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/produit/helitwist-original/?lang=en#reviews">Review HeliTwist</a></div><div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/produit/jeux-darchers/?lang=en#reviews">Review the book</a></div></div></div><div class="legal-card tpulse-product-review-card"><span class="eyebrow">HeliTwist reviews</span><h2>Feedback from archers</h2>[tpulse_product_reviews product="helitwist-original"]<p>Your feedback on post-shot feel, thread choice and stabilizer setup can really help the next archers choose the right model.</p><a class="button secondary" href="/produit/helitwist-original/?lang=en#reviews">Leave a HeliTwist review</a></div><div class="legal-card tpulse-amazon-review-card"><span class="eyebrow">Book reviews</span><h2>The book is also rated on Amazon</h2><div class="tpulse-amazon-rating"><span class="external-rating-score">4.5/5</span><span class="tpulse-amazon-stars" aria-label="4.5 stars out of 5">★★★★★</span><span>21 Amazon ratings</span></div><h3>Reviews submitted on this shop</h3>[tpulse_product_reviews product="jeux-darchers"]<p>Some early readers bought <em>Archery Games</em> on Amazon. You can read those comments on the Amazon listing, alongside reviews left directly on this shop.</p><a class="button secondary" href="https://www.amazon.fr/Jeux-darchers-Perfectionnez-darcherie-samuser/dp/B0DLWNRBPQ#customerReviews" target="_blank" rel="noopener external nofollow">Read Amazon reviews</a></div></div>';
