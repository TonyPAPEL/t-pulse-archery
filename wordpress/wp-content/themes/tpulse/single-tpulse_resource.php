    ...
    <div class="narrow">
        <?php while (have_posts()) : the_post(); ?>
            <article <?php post_class('resource-single'); ?>>
                <a class="text-link" href="<?php echo esc_url(get_post_type_archive_link('tpulse_resource')); ?>">← Toutes les ressources</a>
                ...
                <?php if (tpulse_resource_url(get_the_ID())) : ?>
                    <a class="button resource-download" href="<?php echo esc_url(tpulse_resource_url(get_the_ID())); ?>" target="_blank" rel="noopener">Télécharger ou ouvrir la ressource</a>
                <?php endif; ?>
            </article>
        <?php endwhile; ?>
    </div>
